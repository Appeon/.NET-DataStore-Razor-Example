function init_sidebar() {
    ...
    $MENU_TOGGLE.on("click", function () {
        $BODY.hasClass("nav-md") ? ($SIDEBAR_MENU.find("li.active ul").hide(), $SIDEBAR_MENU.find("li.active").addClass("active-sm").removeClass("active")) : ($SIDEBAR_MENU.find("li.active-sm ul").show(), $SIDEBAR_MENU.find("li.active-sm").addClass("active").removeClass("active-sm")), $BODY.toggleClass("nav-md nav-sm"), $MENU_TOGGLE.children().toggleClass("fa fa-bars fa fa-close"), a()
    }),
...
function init_echarts(mainb, pie) {
    if ("undefined" != typeof echarts) {
        console.log("init_echarts");
        var a = {
            color: [
                '#CFD6DC', '#FEB012', '#43B3E5', '#3C495D',
                '#74B59B', '#8abb6f', '#759c6a', '#bfd3b7'
            ],
            title: {
                itemGap: 8,
                textStyle: {
...
$.fn.popover.Constructor.prototype.leave = function (a) {
    ...
    init_sparklines(), init_flot_chart(), init_sidebar(), init_wysiwyg(), init_InputMask(), init_JQVmap(), init_cropper(), init_knob(), init_IonRangeSlider(), init_ColorPicker(), init_TagsInput(), init_parsley(), init_daterangepicker(), init_daterangepicker_right(), init_daterangepicker_single_call(), init_daterangepicker_reservation(), init_SmartWizard(), init_EasyPieChart(),
        ...
        //init_echarts(),
        //init_morris_charts(),
        init_skycons(), init_select2(), init_validator(), init_DataTables(), init_chart_doughnut(), init_gauge(),
        //init_PNotify(),
