    ...
    public class EditModel : BasePageModel
    {
            ...
            CancellationToken cancellationToken = default)
        {
            try
            {
                ...
                if (SalesOrder != null)
                {
                    var SalesOrderDetails = await _salesOrderDetailService.SearchAsync(
                        new object[] { SalesOrder.SalesOrderID },
                        cancellationToken);

                    SalesOrder.OrderDetails = SalesOrderDetails;
                    SalesOrderDetail = SalesOrderDetails.FirstOrDefault();
